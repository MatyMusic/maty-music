...
// export default function CheckoutSDKClient({
//   orderId,
//   amountILS,
// }: {
//   orderId: string;
...
//           return JSON.parse(t).id; // PayPal Order ID
//         }}
//         onApprove={async (data) => {
//           // מעבירים ל-success שיבצע capture (כבר כתבת שם)
//           window.location.href = `/checkout/success?token=${encodeURIComponent(
//             data.orderID!
//           )}`;
//         }}
//         onError={(e) => {
//           console.error("PayPal onError", e);
//           alert("שגיאה בפתיחת התשלום");
//         }}
//       />
//     </main>
//   );
